...
long int syscall(long int __sysno, ...)
{
	...
	if (__sysno == SYS_renameat2) {
		...
		int olddirfd = va_arg(args, int);
		char *oldpath = va_arg(args, char*);
		int newdirfd = va_arg(args, int);
		char *newpath = va_arg(args, char*);
	...
	// start of auto-generated code
		...
		va_start(args, __sysno);
		int unknown_name0 = va_arg(args, int);
		struct sockaddr * unknown_name1 = va_arg(args, struct sockaddr *);
		int * unknown_name2 = va_arg(args, int *);
		va_end(args);
		...
		struct sockaddr * unknown_name1 = va_arg(args, struct sockaddr *);
		int * unknown_name2 = va_arg(args, int *);
		int unknown_name3 = va_arg(args, int);
		va_end(args);
		...
		va_start(args, __sysno);
		char * _type = va_arg(args, char *);
		char * _description = va_arg(args, char *);
		void * _payload = va_arg(args, void *);
		size_t plen = va_arg(args, size_t);
		key_serial_t destringid = va_arg(args, key_serial_t);
		va_end(args);
		...
		va_start(args, __sysno);
		struct timex * txc_p = va_arg(args, struct timex *);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned long brk = va_arg(args, unsigned long);
		va_end(args);
		...
		va_start(args, __sysno);
		cap_user_header_t header = va_arg(args, cap_user_header_t);
		cap_user_data_t dataptr = va_arg(args, cap_user_data_t);
		va_end(args);
		...
		va_start(args, __sysno);
		char * filename = va_arg(args, char *);
		umode_t mode = (umode_t)va_arg(args, unsigned int);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, filename, mode);
	#endif
	#ifdef SYS_chown
		...
		va_start(args, __sysno);
		char * filename = va_arg(args, char *);
		uid_t user = va_arg(args, uid_t);
		gid_t group = va_arg(args, gid_t);
		va_end(args);
		...
		va_start(args, __sysno);
		char * filename = va_arg(args, char *);
		old_uid_t user = va_arg(args, old_uid_t);
		old_gid_t group = va_arg(args, old_gid_t);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, filename, user, group);
	#endif
	#ifdef SYS_chroot
		...
		va_start(args, __sysno);
		clockid_t which_clock = va_arg(args, clockid_t);
		struct timex * tx = va_arg(args, struct timex *);
		va_end(args);
		...
		va_start(args, __sysno);
		clockid_t which_clock = va_arg(args, clockid_t);
		struct __kernel_timespec * tp = va_arg(args, struct __kernel_timespec *);
		va_end(args);
		...
		clockid_t which_clock = va_arg(args, clockid_t);
		int flags = va_arg(args, int);
		struct __kernel_timespec * rqtp = va_arg(args, struct __kernel_timespec *);
		struct __kernel_timespec * rmtp = va_arg(args, struct __kernel_timespec *);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned long unknown_name0 = va_arg(args, unsigned long);
		unsigned long unknown_name1 = va_arg(args, unsigned long);
		int * unknown_name2 = va_arg(args, int *);
		unsigned long unknown_name3 = va_arg(args, unsigned long);
		int * unknown_name4 = va_arg(args, int *);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned int fd = va_arg(args, unsigned int);
		unsigned int max_fd = va_arg(args, unsigned int);
		...
		va_start(args, __sysno);
		int fd_in = va_arg(args, int);
		loff_t * off_in = va_arg(args, loff_t *);
		int fd_out = va_arg(args, int);
		loff_t * off_out = va_arg(args, loff_t *);
		...
		va_start(args, __sysno);
		char * name_user = va_arg(args, char *);
		unsigned int flags = va_arg(args, unsigned int);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned int fildes = va_arg(args, unsigned int);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned int oldfd = va_arg(args, unsigned int);
		unsigned int newfd = va_arg(args, unsigned int);
		va_end(args);
		...
		size_t sigsetsize = va_arg(args, size_t);
		va_end(args);
		...
		va_start(args, __sysno);
		int fd = va_arg(args, int);
		loff_t offset = va_arg(args, loff_t);
		size_t len = va_arg(args, size_t);
		...
		va_start(args, __sysno);
		unsigned int flags = va_arg(args, unsigned int);
		unsigned int event_f_flags = va_arg(args, unsigned int);
		va_end(args);
		...
		va_start(args, __sysno);
		int fanotify_fd = va_arg(args, int);
		unsigned int flags = va_arg(args, unsigned int);
		u64 mask = va_arg(args, u64);
		int fd = va_arg(args, int);
		char * pathname = va_arg(args, char *);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned int fd = va_arg(args, unsigned int);
		unsigned int cmd = va_arg(args, unsigned int);
		...
		int fs_fd = va_arg(args, int);
		unsigned int flags = va_arg(args, unsigned int);
		unsigned int ms_flags = va_arg(args, unsigned int);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned int fd = va_arg(args, unsigned int);
		struct __old_kernel_stat * statbuf = va_arg(args, struct __old_kernel_stat *);
		va_end(args);
		...
		struct stat64 * statbuf = va_arg(args, struct stat64 *);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, fd, statbuf);
	#endif
	#ifdef SYS_fstatat64
		...
		struct statfs64 * buf = va_arg(args, struct statfs64 *);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned int fd = va_arg(args, unsigned int);
		loff_t length = va_arg(args, loff_t);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, fd, length);
	#endif
	#ifdef SYS_futex
		...
		struct timespec * utime = va_arg(args, struct timespec *);
		u32 * uaddr2 = va_arg(args, u32 *);
		u32 val3 = va_arg(args, u32);
		va_end(args);
		...
		int dfd = va_arg(args, int);
		char * filename = va_arg(args, char *);
		struct timeval * utimes = va_arg(args, struct timeval *);
		va_end(args);
		...
		va_start(args, __sysno);
		int * policy = va_arg(args, int *);
		unsigned long * nmask = va_arg(args, unsigned long *);
		...
		va_start(args, __sysno);
		unsigned * cpu = va_arg(args, unsigned *);
		unsigned * node = va_arg(args, unsigned *);
		struct getcpu_cache * cache = va_arg(args, struct getcpu_cache *);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned int fd = va_arg(args, unsigned int);
		struct linux_dirent * dirent = va_arg(args, struct linux_dirent *);
		unsigned int count = va_arg(args, unsigned int);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned int fd = va_arg(args, unsigned int);
		struct linux_dirent64 * dirent = va_arg(args, struct linux_dirent64 *);
		unsigned int count = va_arg(args, unsigned int);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, fd, dirent, count);
	#endif
		...
		gid_t * grouplist = va_arg(args, gid_t *);
		va_end(args);
		...
		va_start(args, __sysno);
		int gidsetsize = va_arg(args, int);
		old_gid_t * grouplist = va_arg(args, old_gid_t *);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, gidsetsize, grouplist);
	#endif
		...
		struct itimerval * value = va_arg(args, struct itimerval *);
		va_end(args);
		...
		va_start(args, __sysno);
		old_gid_t * rgid = va_arg(args, old_gid_t *);
		old_gid_t * egid = va_arg(args, old_gid_t *);
		old_gid_t * sgid = va_arg(args, old_gid_t *);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, rgid, egid, sgid);
	#endif
	#ifdef SYS_getresuid
		...
		va_start(args, __sysno);
		old_uid_t * ruid = va_arg(args, old_uid_t *);
		old_uid_t * euid = va_arg(args, old_uid_t *);
		old_uid_t * suid = va_arg(args, old_uid_t *);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, ruid, euid, suid);
	#endif
	#ifdef SYS_getrlimit
		...
		va_start(args, __sysno);
		unsigned int resource = va_arg(args, unsigned int);
		struct rlimit * rlim = va_arg(args, struct rlimit *);
		va_end(args);
		...
		va_start(args, __sysno);
		int who = va_arg(args, int);
		struct rusage * ru = va_arg(args, struct rusage *);
		va_end(args);
		...
		char * optval = va_arg(args, char *);
		int * optlen = va_arg(args, int *);
		va_end(args);
		...
		va_start(args, __sysno);
		aio_context_t ctx_id = va_arg(args, aio_context_t);
		struct iocb * iocb = va_arg(args, struct iocb *);
		struct io_event * result = va_arg(args, struct io_event *);
		va_end(args);
		...
		va_start(args, __sysno);
		aio_context_t ctx = va_arg(args, aio_context_t);
		va_end(args);
		...
		va_start(args, __sysno);
		aio_context_t ctx_id = va_arg(args, aio_context_t);
		long min_nr = va_arg(args, long);
		long nr = va_arg(args, long);
		struct io_event * events = va_arg(args, struct io_event *);
		...
		struct io_event * events = va_arg(args, struct io_event *);
		struct timespec * timeout = va_arg(args, struct timespec *);
		struct __aio_sigset * sig = va_arg(args, struct __aio_sigset *);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned nr_reqs = va_arg(args, unsigned);
		aio_context_t * ctx = va_arg(args, aio_context_t *);
		va_end(args);
		...
		va_start(args, __sysno);
		aio_context_t unknown_name0 = va_arg(args, aio_context_t);
		long unknown_name1 = va_arg(args, long);
		struct iocb * * unknown_name2 = va_arg(args, struct iocb * *);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, unknown_name0, unknown_name1, unknown_name2);
	#endif
		...
		va_start(args, __sysno);
		unsigned int fd = va_arg(args, unsigned int);
		u32 to_submit = va_arg(args, u32);
		u32 min_complete = va_arg(args, u32);
		u32 flags = va_arg(args, u32);
		sigset_t * sig = va_arg(args, sigset_t *);
		size_t sigsz = va_arg(args, size_t);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned int fd = va_arg(args, unsigned int);
		unsigned int op = va_arg(args, unsigned int);
		void * arg = va_arg(args, void *);
		unsigned int nr_args = va_arg(args, unsigned int);
		va_end(args);
		...
		va_start(args, __sysno);
		u32 entries = va_arg(args, u32);
		struct io_uring_params * p = va_arg(args, struct io_uring_params *);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned long from = va_arg(args, unsigned long);
		...
		va_start(args, __sysno);
		pid_t pid1 = va_arg(args, pid_t);
		pid_t pid2 = va_arg(args, pid_t);
		int type = va_arg(args, int);
		unsigned long idx1 = va_arg(args, unsigned long);
		unsigned long idx2 = va_arg(args, unsigned long);
		va_end(args);
		...
		va_start(args, __sysno);
		int kernel_fd = va_arg(args, int);
		int initrd_fd = va_arg(args, int);
		unsigned long cmdline_len = va_arg(args, unsigned long);
		char * cmdline_ptr = va_arg(args, char *);
		unsigned long flags = va_arg(args, unsigned long);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned long entry = va_arg(args, unsigned long);
		unsigned long nr_segments = va_arg(args, unsigned long);
		struct kexec_segment * segments = va_arg(args, struct kexec_segment *);
		unsigned long flags = va_arg(args, unsigned long);
		va_end(args);
		...
		va_start(args, __sysno);
		char * oldname = va_arg(args, char *);
		char * newname = va_arg(args, char *);
		va_end(args);
		...
		va_start(args, __sysno);
		int olddfd = va_arg(args, int);
		char * oldname = va_arg(args, char *);
		int newdfd = va_arg(args, int);
		char * newname = va_arg(args, char *);
		int flags = va_arg(args, int);
		va_end(args);
		...
		va_start(args, __sysno);
		int unknown_name0 = va_arg(args, int);
		int unknown_name1 = va_arg(args, int);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned int fd = va_arg(args, unsigned int);
		unsigned long offset_high = va_arg(args, unsigned long);
		unsigned long offset_low = va_arg(args, unsigned long);
		loff_t * result = va_arg(args, loff_t *);
		unsigned int whence = va_arg(args, unsigned int);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned long start = va_arg(args, unsigned long);
		size_t len = va_arg(args, size_t);
		int behavior = va_arg(args, int);
		va_end(args);
		...
		va_start(args, __sysno);
		char * uname_ptr = va_arg(args, char *);
		unsigned int flags = va_arg(args, unsigned int);
		va_end(args);
		...
		unsigned long maxnode = va_arg(args, unsigned long);
		unsigned long * from = va_arg(args, unsigned long *);
		unsigned long * to = va_arg(args, unsigned long *);
		va_end(args);
		...
		unsigned long start = va_arg(args, unsigned long);
		size_t len = va_arg(args, size_t);
		unsigned char *  vec = va_arg(args, unsigned char *);
		va_end(args);
		...
		char * filename = va_arg(args, char *);
		umode_t mode = (umode_t)va_arg(args, unsigned int);
		unsigned dev = va_arg(args, unsigned);
		va_end(args);
		...
		unsigned long flags = va_arg(args, unsigned long);
		unsigned long fd = va_arg(args, unsigned long);
		unsigned long pgoff = va_arg(args, unsigned long);
		va_end(args);
		...
		va_start(args, __sysno);
		char * dev_name = va_arg(args, char *);
		char * dir_name = va_arg(args, char *);
		...
		va_start(args, __sysno);
		int from_dfd = va_arg(args, int);
		char * from_path = va_arg(args, char *);
		int to_dfd = va_arg(args, int);
		char * to_path = va_arg(args, char *);
		unsigned int ms_flags = va_arg(args, unsigned int);
		va_end(args);
		...
		va_start(args, __sysno);
		pid_t pid = va_arg(args, pid_t);
		unsigned long nr_pages = va_arg(args, unsigned long);
		...
		va_start(args, __sysno);
		mqd_t mqdes = va_arg(args, mqd_t);
		struct mq_attr * mqstat = va_arg(args, struct mq_attr *);
		struct mq_attr * omqstat = va_arg(args, struct mq_attr *);
		va_end(args);
		...
		va_start(args, __sysno);
		mqd_t mqdes = va_arg(args, mqd_t);
		struct sigevent * notification = va_arg(args, struct sigevent *);
		va_end(args);
		...
		va_start(args, __sysno);
		mqd_t mqdes = va_arg(args, mqd_t);
		char * msg_ptr = va_arg(args, char *);
		size_t msg_len = va_arg(args, size_t);
		unsigned int * msg_prio = va_arg(args, unsigned int *);
		struct __kernel_timespec * abs_timeout = va_arg(args, struct __kernel_timespec *);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned long addr = va_arg(args, unsigned long);
		unsigned long old_len = va_arg(args, unsigned long);
		unsigned long new_len = va_arg(args, unsigned long);
		unsigned long flags = va_arg(args, unsigned long);
		unsigned long new_addr = va_arg(args, unsigned long);
		va_end(args);
		...
		va_start(args, __sysno);
		int msqid = va_arg(args, int);
		struct msgbuf * msgp = va_arg(args, struct msgbuf *);
		...
		int dfd = va_arg(args, int);
		char * name = va_arg(args, char *);
		struct file_handle * handle = va_arg(args, struct file_handle *);
		int * mnt_id = va_arg(args, int *);
		int flag = va_arg(args, int);
		va_end(args);
		...
		va_start(args, __sysno);
		struct new_utsname * name = va_arg(args, struct new_utsname *);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, name);
	#endif
		...
		va_start(args, __sysno);
		struct mmap_arg_struct * arg = va_arg(args, struct mmap_arg_struct *);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned int unknown_name0 = va_arg(args, unsigned int);
		struct old_linux_dirent * unknown_name1 = va_arg(args, struct old_linux_dirent *);
		unsigned int unknown_name2 = va_arg(args, unsigned int);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, unknown_name0, unknown_name1, unknown_name2);
	#endif
		...
		va_start(args, __sysno);
		struct sel_arg_struct * arg = va_arg(args, struct sel_arg_struct *);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, arg);
	#endif
	#ifdef SYS_oldumount
		...
		va_start(args, __sysno);
		struct oldold_utsname * unknown_name0 = va_arg(args, struct oldold_utsname *);
		va_end(args);
		...
		va_start(args, __sysno);
		int mountdirfd = va_arg(args, int);
		struct file_handle * handle = va_arg(args, struct file_handle *);
		int flags = va_arg(args, int);
		va_end(args);
		...
		int dfd = va_arg(args, int);
		char * filename = va_arg(args, char *);
		struct open_how * how = va_arg(args, struct open_how *);
		size_t size = va_arg(args, size_t);
		va_end(args);
		...
		va_start(args, __sysno);
		long which = va_arg(args, long);
		unsigned long bus = va_arg(args, unsigned long);
		unsigned long devfn = va_arg(args, unsigned long);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned long bus = va_arg(args, unsigned long);
		unsigned long dfn = va_arg(args, unsigned long);
		unsigned long off = va_arg(args, unsigned long);
		unsigned long len = va_arg(args, unsigned long);
		...
		va_start(args, __sysno);
		struct perf_event_attr * attr_uptr = va_arg(args, struct perf_event_attr *);
		pid_t pid = va_arg(args, pid_t);
		...
		va_start(args, __sysno);
		unsigned int personality = va_arg(args, unsigned int);
		va_end(args);
		...
		va_start(args, __sysno);
		char * new_root = va_arg(args, char *);
		char * put_old = va_arg(args, char *);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned long flags = va_arg(args, unsigned long);
		unsigned long init_val = va_arg(args, unsigned long);
		va_end(args);
		...
		va_start(args, __sysno);
		struct pollfd * ufds = va_arg(args, struct pollfd *);
		unsigned int nfds = va_arg(args, unsigned int);
		int timeout = va_arg(args, int);
		va_end(args);
		...
		va_start(args, __sysno);
		struct pollfd * unknown_name0 = va_arg(args, struct pollfd *);
		unsigned int unknown_name1 = va_arg(args, unsigned int);
		struct timespec * unknown_name2 = va_arg(args, struct timespec *);
		sigset_t * unknown_name3 = va_arg(args, sigset_t *);
		size_t unknown_name4 = va_arg(args, size_t);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, unknown_name0, unknown_name1, unknown_name2, unknown_name3, unknown_name4);
	#endif
	#ifdef SYS_prctl
		...
		va_start(args, __sysno);
		unsigned long fd = va_arg(args, unsigned long);
		struct iovec * vec = va_arg(args, struct iovec *);
		unsigned long vlen = va_arg(args, unsigned long);
		unsigned long pos_l = va_arg(args, unsigned long);
		unsigned long pos_h = va_arg(args, unsigned long);
		va_end(args);
		...
		pid_t pid = va_arg(args, pid_t);
		unsigned int resource = va_arg(args, unsigned int);
		struct rlimit64 * new_rlim = va_arg(args, struct rlimit64 *);
		struct rlimit64 * old_rlim = va_arg(args, struct rlimit64 *);
		va_end(args);
		...
		va_start(args, __sysno);
		pid_t pid = va_arg(args, pid_t);
		struct iovec * lvec = va_arg(args, struct iovec *);
		unsigned long liovcnt = va_arg(args, unsigned long);
		struct iovec * rvec = va_arg(args, struct iovec *);
		...
		va_start(args, __sysno);
		int unknown_name0 = va_arg(args, int);
		fd_set * unknown_name1 = va_arg(args, fd_set *);
		fd_set * unknown_name2 = va_arg(args, fd_set *);
		fd_set * unknown_name3 = va_arg(args, fd_set *);
		struct timespec * unknown_name4 = va_arg(args, struct timespec *);
		void * unknown_name5 = va_arg(args, void *);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned int cmd = va_arg(args, unsigned int);
		char * special = va_arg(args, char *);
		qid_t id = va_arg(args, qid_t);
		...
		va_start(args, __sysno);
		int unknown_name0 = va_arg(args, int);
		void * unknown_name1 = va_arg(args, void *);
		size_t unknown_name2 = va_arg(args, size_t);
		unsigned unknown_name3 = va_arg(args, unsigned);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, unknown_name0, unknown_name1, unknown_name2, unknown_name3);
	#endif
	#ifdef SYS_recvfrom
		...
		size_t unknown_name2 = va_arg(args, size_t);
		unsigned unknown_name3 = va_arg(args, unsigned);
		struct sockaddr * unknown_name4 = va_arg(args, struct sockaddr *);
		int * unknown_name5 = va_arg(args, int *);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, unknown_name0, unknown_name1, unknown_name2, unknown_name3, unknown_name4, unknown_name5);
	#endif
	#ifdef SYS_recvmmsg
		...
		va_start(args, __sysno);
		int fd = va_arg(args, int);
		struct mmsghdr * msg = va_arg(args, struct mmsghdr *);
		...
		va_start(args, __sysno);
		int fd = va_arg(args, int);
		struct user_msghdr * msg = va_arg(args, struct user_msghdr *);
		unsigned flags = va_arg(args, unsigned);
		va_end(args);
		...
		char * _type = va_arg(args, char *);
		char * _description = va_arg(args, char *);
		char * _callout_info = va_arg(args, char *);
		key_serial_t destringid = va_arg(args, key_serial_t);
		va_end(args);
		...
		va_start(args, __sysno);
		struct rseq * rseq = va_arg(args, struct rseq *);
		uint32_t rseq_len = va_arg(args, uint32_t);
		int flags = va_arg(args, int);
		uint32_t sig = va_arg(args, uint32_t);
		va_end(args);
		...
		va_start(args, __sysno);
		int unknown_name0 = va_arg(args, int);
		struct sigaction * unknown_name1 = va_arg(args, struct sigaction *);
		struct sigaction * unknown_name2 = va_arg(args, struct sigaction *);
		size_t unknown_name3 = va_arg(args, size_t);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, unknown_name0, unknown_name1, unknown_name2, unknown_name3);
	#endif
		...
		va_start(args, __sysno);
		sigset_t * set = va_arg(args, sigset_t *);
		size_t sigsetsize = va_arg(args, size_t);
		va_end(args);
		...
		sigset_t * set = va_arg(args, sigset_t *);
		sigset_t * oset = va_arg(args, sigset_t *);
		size_t sigsetsize = va_arg(args, size_t);
		va_end(args);
		...
		pid_t pid = va_arg(args, pid_t);
		int sig = va_arg(args, int);
		siginfo_t * uinfo = va_arg(args, siginfo_t *);
		va_end(args);
		...
		va_start(args, __sysno);
		sigset_t * unewset = va_arg(args, sigset_t *);
		size_t sigsetsize = va_arg(args, size_t);
		va_end(args);
		...
		va_start(args, __sysno);
		sigset_t * uthese = va_arg(args, sigset_t *);
		siginfo_t * uinfo = va_arg(args, siginfo_t *);
		struct timespec * uts = va_arg(args, struct timespec *);
		size_t sigsetsize = va_arg(args, size_t);
		va_end(args);
		...
		unsigned long * user_mask_ptr = va_arg(args, unsigned long *);
		va_end(args);
		...
		va_start(args, __sysno);
		pid_t pid = va_arg(args, pid_t);
		struct sched_attr * attr = va_arg(args, struct sched_attr *);
		unsigned int size = va_arg(args, unsigned int);
		unsigned int flags = va_arg(args, unsigned int);
		va_end(args);
		...
		va_start(args, __sysno);
		pid_t pid = va_arg(args, pid_t);
		struct sched_param * param = va_arg(args, struct sched_param *);
		va_end(args);
		...
		va_start(args, __sysno);
		pid_t pid = va_arg(args, pid_t);
		struct timespec * interval = va_arg(args, struct timespec *);
		va_end(args);
		...
		fd_set * inp = va_arg(args, fd_set *);
		fd_set * outp = va_arg(args, fd_set *);
		fd_set * exp = va_arg(args, fd_set *);
		struct timeval * tvp = va_arg(args, struct timeval *);
		va_end(args);
		...
		unsigned nsops = va_arg(args, unsigned);
		va_end(args);
		...
		struct sembuf * sops = va_arg(args, struct sembuf *);
		unsigned nsops = va_arg(args, unsigned);
		struct __kernel_timespec * timeout = va_arg(args, struct __kernel_timespec *);
		va_end(args);
		...
		va_start(args, __sysno);
		struct robust_list_head * head = va_arg(args, struct robust_list_head *);
		size_t len = va_arg(args, size_t);
		va_end(args);
		...
		va_start(args, __sysno);
		old_gid_t gid = va_arg(args, old_gid_t);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, gid);
	#endif
	#ifdef SYS_setfsuid
		...
		va_start(args, __sysno);
		old_uid_t uid = va_arg(args, old_uid_t);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, uid);
	#endif
	#ifdef SYS_setgid
		...
		int which = va_arg(args, int);
		struct itimerval * value = va_arg(args, struct itimerval *);
		struct itimerval * ovalue = va_arg(args, struct itimerval *);
		va_end(args);
		...
		va_start(args, __sysno);
		int unknown_name0 = va_arg(args, int);
		struct old_sigaction * unknown_name1 = va_arg(args, struct old_sigaction *);
		struct old_sigaction * unknown_name2 = va_arg(args, struct old_sigaction *);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, unknown_name0, unknown_name1, unknown_name2);
	#endif
		...
		va_start(args, __sysno);
		struct sigaltstack * uss = va_arg(args, struct sigaltstack *);
		struct sigaltstack * uoss = va_arg(args, struct sigaltstack *);
		va_end(args);
		...
		va_start(args, __sysno);
		int sig = va_arg(args, int);
		__sighandler_t handler = va_arg(args, __sighandler_t);
		va_end(args);
		...
		va_start(args, __sysno);
		int ufd = va_arg(args, int);
		sigset_t * user_mask = va_arg(args, sigset_t *);
		size_t sizemask = va_arg(args, size_t);
		va_end(args);
		...
		va_start(args, __sysno);
		old_sigset_t * uset = va_arg(args, old_sigset_t *);
		va_end(args);
		...
		va_start(args, __sysno);
		int how = va_arg(args, int);
		old_sigset_t * set = va_arg(args, old_sigset_t *);
		old_sigset_t * oset = va_arg(args, old_sigset_t *);
		va_end(args);
		...
		va_start(args, __sysno);
		old_sigset_t mask = va_arg(args, old_sigset_t);
		va_end(args);
		...
		va_start(args, __sysno);
		int call = va_arg(args, int);
		unsigned long * args = va_arg(args, unsigned long *);
		va_end(args);
		...
		va_start(args, __sysno);
		int fd = va_arg(args, int);
		__u32 * unpc = va_arg(args, __u32 *);
		__u32 * ustatus = va_arg(args, __u32 *);
		va_end(args);
		...
		struct statx * buffer = va_arg(args, struct statx *);
		va_end(args);
		...
		va_start(args, __sysno);
		time_t * tptr = va_arg(args, time_t *);
		va_end(args);
		...
		va_start(args, __sysno);
		char * specialfile = va_arg(args, char *);
		va_end(args);
		...
		va_start(args, __sysno);
		char * specialfile = va_arg(args, char *);
		int swap_flags = va_arg(args, int);
		va_end(args);
		...
		int fd = va_arg(args, int);
		loff_t offset = va_arg(args, loff_t);
		loff_t nbytes = va_arg(args, loff_t);
		unsigned int flags = va_arg(args, unsigned int);
		va_end(args);
		...
		va_start(args, __sysno);
		struct __sysctl_args * args = va_arg(args, struct __sysctl_args *);
		va_end(args);
		...
		va_start(args, __sysno);
		struct sysinfo * info = va_arg(args, struct sysinfo *);
		va_end(args);
		...
		va_start(args, __sysno);
		int fdin = va_arg(args, int);
		int fdout = va_arg(args, int);
		size_t len = va_arg(args, size_t);
		unsigned int flags = va_arg(args, unsigned int);
		va_end(args);
		...
		va_start(args, __sysno);
		time_t * tloc = va_arg(args, time_t *);
		va_end(args);
		...
		va_start(args, __sysno);
		clockid_t which_clock = va_arg(args, clockid_t);
		struct sigevent * timer_event_spec = va_arg(args, struct sigevent *);
		timer_t *  created_timer_id = va_arg(args, timer_t *);
		va_end(args);
		...
		va_start(args, __sysno);
		timer_t timer_id = va_arg(args, timer_t);
		va_end(args);
		...
		va_start(args, __sysno);
		timer_t timer_id = va_arg(args, timer_t);
		struct itimerspec * setting = va_arg(args, struct itimerspec *);
		va_end(args);
		...
		timer_t timer_id = va_arg(args, timer_t);
		int flags = va_arg(args, int);
		struct itimerspec * new_setting = va_arg(args, struct itimerspec *);
		struct itimerspec * old_setting = va_arg(args, struct itimerspec *);
		va_end(args);
		...
		va_start(args, __sysno);
		int ufd = va_arg(args, int);
		struct itimerspec * otmr = va_arg(args, struct itimerspec *);
		va_end(args);
		...
		int ufd = va_arg(args, int);
		int flags = va_arg(args, int);
		struct itimerspec * utmr = va_arg(args, struct itimerspec *);
		struct itimerspec * otmr = va_arg(args, struct itimerspec *);
		va_end(args);
		...
		va_start(args, __sysno);
		struct tms * tbuf = va_arg(args, struct tms *);
		va_end(args);
		...
		va_start(args, __sysno);
		struct old_utsname * unknown_name0 = va_arg(args, struct old_utsname *);
		va_end(args);
		syscall_status = syscall_fn_ptr(__sysno, unknown_name0);
	#endif
	#ifdef SYS_unlink
		...
		va_start(args, __sysno);
		unsigned long unshare_flags = va_arg(args, unsigned long);
		va_end(args);
		...
		va_start(args, __sysno);
		unsigned dev = va_arg(args, unsigned);
		struct ustat * ubuf = va_arg(args, struct ustat *);
		va_end(args);
		...
		va_start(args, __sysno);
		char * filename = va_arg(args, char *);
		struct utimbuf * times = va_arg(args, struct utimbuf *);
		va_end(args);
		...
		int dfd = va_arg(args, int);
		char * filename = va_arg(args, char *);
		struct timespec * utimes = va_arg(args, struct timespec *);
		int flags = va_arg(args, int);
		va_end(args);
		...
		unsigned long nr_segs = va_arg(args, unsigned long);
		unsigned int flags = va_arg(args, unsigned int);
		va_end(args);
		...
		int which = va_arg(args, int);
		pid_t pid = va_arg(args, pid_t);
		struct siginfo * infop = va_arg(args, struct siginfo *);
		int options = va_arg(args, int);
		struct rusage * ru = va_arg(args, struct rusage *);
		va_end(args);
